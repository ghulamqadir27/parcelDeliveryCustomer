    ...
    <View style={styles.imgView}>
        ...
        <View style={styles.contentContainerStyle}>
         ...
         <Row style={styles.loginview}>
                <Regular fontSize={mvs(16)} label={'Don’t have an account?'} color={colors.subText} style={styles.textStyle}/>
                <TouchableOpacity onPress={() => navigate('SignUp')}>
                  <Regular style={{fontWeight:'bold'}} fontSize={mvs(16)} label={'Sign Up'} color={colors.subText} />
                </TouchableOpacity>
              </Row>
      </ScrollView>
    </View>
