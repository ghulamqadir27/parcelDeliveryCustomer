...
const DeliveryParcelPickupScreen = () => {
...
<View style={{marginVertical:mvs(8)}}> 
        ...
        <View style={{marginBottom:mvs(10)}}>
         <SwipeStartPickupLocationButton
              onAccept={() =>navigate('DeliveryParcelDelieveredScreen')} 
              />
              </View>
      </View>
    </View>
...
export default DeliveryParcelPickupScreen;
