...
const WareHouseMapRouteScreen = () => {
  ...
  return (
    <View style={{flex: 1, backgroundColor: colors.white}}>
      <Header1x2x title={'WareHouse Map Routing'} />
   ...
   showsUserLocation={false}
      ...
      {/* <PrimaryButton
                    ...
                    /> */}
<View style={{marginBottom:mvs(10),marginHorizontal:mvs(10), marginVertical:mvs(20)}}>
...
export default WareHouseMapRouteScreen;
