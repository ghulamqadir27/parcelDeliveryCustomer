...
const DriverRegistrationPart3Screen = props => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Image source={IMG.Stepper3} resizeMode='contain' style={styles.imglogo} />
        <Medium label={'Step 3 / 10'} fontSize={mvs(12)} color={colors.black}/> 
          ...
          <KeyboardAvoidScrollview
            ...
            <View style={styles.contentContainerStyleNew}>
              <Formik
                ...
                {({
                  ...
                  <>
                   ...
                   <PrimaryInput
                    ...
                    placeholder={'License Isuusance Country'}
                    // isRequired
                ...
                <Medium style={{fontWeight:"500"}} color={colors.black} fontSize={mvs(13)} label='Upload a clear photo of your Driver License'/>
...
{backImage ? (
  ...
  />
       ...
       <PrimaryButton
                                  ...
                                  loading={loading}
                                  // onPress={handleSubmit}
                                  onPress={()=>navigate("DriverRegistrationPart4Screen")}
                                  title={'Next'}
                                />
...
export default DriverRegistrationPart3Screen;