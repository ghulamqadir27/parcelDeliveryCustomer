...
export const ONBOARDING_LIST = [
  {
    ...
    desc: 'Get instant updates on your parcel’s journey — from pickup to doorstep.',    
  },
  {
    image: IMG.onboardingsecond,
    title: 'Never Miss a Delivery',
    desc: 'Receive timely alerts when your parcel is nearby, delivered, or delayed.',    
  },
  {
    image: IMG.onboardingthird,
    title: 'Seamless & Secure Experience',
    desc: 'No logins or confusion — just enter your tracking code and monitor your parcel easily.',    
  },
];
